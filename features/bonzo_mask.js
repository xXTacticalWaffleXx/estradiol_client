...
import {screenWidthPercentage} from "../utils/utils.js"
import {screenHeightPercentage} from "../utils/utils.js"
...
register("renderOverlay", () => {
  ...
  if (fragged_used) {Renderer.drawStringWithShadow("&d[Fragged] &4Used", x, y + 10)}
  else {Renderer.drawStringWithShadow("&d[Fragged] &2Ready", x, y + 10)}
  if (unfragged_used) {Renderer.drawStringWithShadow("&d[Unfragged] &4Used", x, y + 20)}
